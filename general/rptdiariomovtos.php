...
<input type="hidden" name="hidfecha" value="">
          ...
          <tr>
             ...
             <td align="right">
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                      ...
                      <tr>
                        <td class="cifras">Fecha:</td>
                        <td><img src="../html/images/blank.gif" width="10" height="1"></td>
                        <td><input type="text" name="txtfecha" size="15" value="<?=date("Y-m-d")?>" class="txt10Vgris"><img src="../html/images/blank.gif" width="3" height="1"><a href="#" name="anchor_fh" onclick="ocalendar.select(document.frmcriterio.txtfecha, 'anchor_fh','yyyy-MM-dd')"><img src="../html/images/botones/B_date.gif" width="13" height="13" border="0"></a></td>
