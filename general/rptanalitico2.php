...
function toprint() {
   window.open("rptanalitico2.php?id=<?=$id?>&hidmes=<?=$hidmes?>&hidcuentaini=<?=$hidcuentaini?>&hidcuentafin=<?=$hidcuentafin?>&hidtoprint=1", "", "scrollbars=yes,top=100,left=200,width=450,height=310");
}
...
<tr> 
    <td> 
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr> 
          <td width="300" class="titulos01" valign="top"><b>analitico</b>de<b>auxiliares</b></td>
            ...
            <td> 
              <table border="0" cellspacing="0" cellpadding="2" width="100%">
                ...
                <tr> 
                  ...
                  <td bgcolor="#7E9EDF"> 
                    <div align="center" class="Tittablas">FECHA</div>
                  </td>
                  <td background="../html/images/tablas/fnd07.gif">&nbsp;</td>
                  <td bgcolor="#7E9EDF"> 
