...
require_once("../comun/TpcuentaBean.php");
require_once("../comun/PaisBean.php");
require_once("BIZCatalogos.php");

/**
 * Programa: mantpcuenta.php
 * Descripcion:
 *   Script para dar mantenimiento al catalogo de tipos de cuenta
 * Autor:
 *   HANYGEN Software S.A. de C.V. 
 *   Ruben Murga Tapia
 **/
$obus = new BIZCatalogos();
$oobj = new TpcuentaBean();

$mensaje = "";
$hidopcion = $_POST['hidopcion'];

if($hidopcion=="upd") {
  $oobj = $obus->getTpcuentaBean($_POST['hidclave'], $conn);
}

if($hidopcion=="add") {
  $oobj->setcdpais($_POST['cbopais']);
  $oobj->setnbtpcuenta($_POST['txtnombre']);
  if(!$obus->addTpcuentaBean($oobj, $conn)) {
    $mensaje = "ERROR al querer agregar un nuevo tipo de cuenta";  
  } else {
    $mensaje = "Se ha agregado el tipo de cuenta con exito";  
    $oobj = new TpcuentaBean();
  }
  $hidopcion="";
}
...
if($hidopcion=="update") {
  ...
  $oobj->setcdpais($_POST['cbopais']);
  $oobj->setnbtpcuenta($_POST['txtnombre']);
  $oobj->setsttpcuenta($_POST['chkestatus']);
  if(!$obus->updTpcuentaBean($oobj, $conn)) {
    $mensaje = "ERROR al querer actualizar un nuevo tipo de cuenta";  
  } else {
    $mensaje = "Se ha actualizado el tipo de cuenta con exito";  
    $oobj = new TpcuentaBean();
  }
  $hidopcion="";
}
...
function eliminar(clave) {
    if(!confirm("Esta seguro de querer eliminar el tipo de cuenta contable ?")) return;
    form.hidclave.value = clave;
...
<table border="0" width="650" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td class="titulos01">tipo<b>de</b>cuenta<b>contable</b></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <?php
     ...
     ?>
                <tr>
                  <td <?if($it%2==0) echo "bgcolor='#E5ECF9'"; ?> class="txtV10Gris2" ><?=$orow->getcdtpcuenta()?></td>
                  <td background="../html/images/tablas/<?=($it%2==0?'fnd02.gif':'fnd03.gif')?>" bgcolor="#CCCCCC">&nbsp;</td>
                  <td <?if($it%2==0) echo "bgcolor='#E5ECF9'"; ?> class="txtV10Gris2"><div align="center"><?=$orow->getnbtpcuenta()?></div>
                  </td>
                  <td background="../html/images/tablas/<?=($it%2==0?'fnd02.gif':'fnd03.gif')?>" bgcolor="#CCCCCC">&nbsp;</td>
                  ...
                  <td <?if($it%2==0) echo "bgcolor='#E5ECF9'"; ?>>
                    <div align="center"><img src="../html/images/iconos/<?=($orow->getsttpcuenta()=="AC"?'I_paloma.gif':'I_tache.gif')?>" width="15" height="13"></div>
                  </td>
                  <td background="../html/images/tablas/<?=($it%2==0?'fnd02.gif':'fnd03.gif')?>" bgcolor="#CCCCCC">&nbsp;</td>
                  <td <?if($it%2==0) echo "bgcolor='#E5ECF9'"; ?> class="txtV10Gris2">
                    <div align="center"><a href="javascript:select('<?=$orow->getcdtpcuenta()?>')"><img src="../html/images/botones/B_edit.gif" width="18" height="16" border="0"></a></div>
                  </td>
                  <td background="../html/images/tablas/<?=($it%2==0?'fnd02.gif':'fnd03.gif')?>" bgcolor="#CCCCCC">&nbsp;</td>
                  <td <?if($it%2==0) echo "bgcolor='#E5ECF9'"; ?> class="txtV10Gris2">
                    <div align="center">
                            <?if($orow->getsttpcuenta()=="AC") { ?><a href="javascript:eliminar('<?=$orow->getcdtpcuenta()?>')"><img src="../html/images/botones/B_del.gif" width="18" height="16" border="0"></a><? } else { ?><img src="../html/images/botones/B_del_disabled.gif" width="18" height="16" border="0"><? } ?></div>
                  </td>
                </tr>
     <? $it = $it + 1; 
          } } ?>
               ...
               <!--  inicia renglon para agregar un nuevo registro -->
                <tr>
                  <td class="txtV10Gris2"><div align="center"><?=$oobj->getcdtpcuenta()?></div></td>
                  <td background="../html/images/tablas/fnd03.gif" bgcolor="#CCCCCC">&nbsp;</td>
                  <td class="txtV10Gris2">
                    <div align="center"><input type="text" class="txtV10Gris2" name="txtnombre" size="20" maxlength="100" value="<?=$oobj->getnbtpcuenta()?>"></div>
                  </td>
                  <td background="../html/images/tablas/fnd03.gif" bgcolor="#CCCCCC">&nbsp;</td>
                  ...
                  <td background="../html/images/tablas/fnd03.gif" bgcolor="#CCCCCC">&nbsp;</td>
                  <td>
                    <div align="center"><? if($hidopcion=="upd") { ?><input type="checkbox" name="chkestatus" class="txtV10Gris2" value='AC' <?if($oobj->getsttpcuenta()=="AC") echo 'checked'; ?>><? } ?>&nbsp;</div>
                  </td>
                  <td background="../html/images/tablas/fnd03.gif" bgcolor="#CCCCCC">&nbsp;</td>
